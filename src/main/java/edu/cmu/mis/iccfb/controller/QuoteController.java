...
public class QuoteController {
    ...
    @RequestMapping(value = "/api/quote/list", method = RequestMethod.POST)
    public Quote list( @RequestBody String authorName) {
        System.out.println("QuoteController : " + authorName);
        authorName = authorName.replaceAll("\\r\\n", "");
        return quoteService.QuoteByAuthor(authorName);
    } 
